...
import com.example.earth.databinding.FragmentEditCheckboxBinding;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

public class EditCheckboxFragment extends Fragment {
FragmentEditCheckboxBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding=FragmentEditCheckboxBinding.inflate(inflater, container, false);
